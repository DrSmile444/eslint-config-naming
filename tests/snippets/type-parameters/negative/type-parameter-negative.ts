...
// ❌ No T prefix for descriptive names - should use TPayload
function bad3<Payload>(payload: Payload): Payload {
  return payload;
}
...
// ❌ camelCase - should use PascalCase like TPayload
function bad7<tPayload>(payload: tPayload): tPayload {
  return payload;
}
